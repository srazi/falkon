...
LangString DESC_StandardInstallation ${LANG_FARSI} "Falkon will be installed on your computer."
...
;;;;Simplified Chinese
LangString PRODUCT_DESC  ${LANG_SIMPCHINESE} "Falkon 是新出、高速、安全的开源 WWW 浏览器。Falkon 基于 GPL 协议第 3 版或（如果您需要）任何之后的版本。它使用 WebKit 排版引擎。"
;
